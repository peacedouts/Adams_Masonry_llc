...
Static HTML & CSS, single page, no frameworks or build step
...
Cloudflare static page hosting
...
Cloudflare email address obfuscation on public contact links
